    ...
    <div className="mx-auto max-w-5xl p-6 space-y-6">
      <section className="relative overflow-hidden rounded-2xl border bg-[var(--pp-panel)]" style={{ borderColor: 'var(--pp-border)' }}>
        ...
        <div className="relative z-10 p-4 md:p-6">
          <div className="text-sm opacity-70"><Link className="hover:underline focus:underline focus:outline-none" href="/">{pl.nav.dashboard}</Link> › <span>{pl.nav.settings}</span></div>
          <h1 className="mt-1 text-2xl md:text-3xl font-semibold">{pl.settings.title}</h1>
        </div>
      </section>
