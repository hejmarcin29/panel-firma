  ...
  return (
    <div className="mx-auto max-w-5xl p-6 space-y-6">
      <div className="text-sm opacity-70">
        ...
        &rsaquo; <span>{pl.settings.usersSection}</span>
      </div>
      <h1 className="text-2xl font-semibold">{pl.settings.usersSection}</h1>
      <div className="flex items-center justify-between">
        <div></div>
        <Link
          href="/ustawienia/uzytkownicy/nowy"
          className="inline-flex h-9 items-center rounded-md border border-black/15 px-3 text-sm dark:border-white/15 hover:bg-black/5 dark:hover:bg-white/10"
        >
          Dodaj użytkownika
        </Link>
      </div>
