      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm opacity-80">
            Plan: montażysta może połączyć własny kalendarz Google (OAuth), a
            terminy przypisanych montaży będą automatycznie
            tworzone/aktualizowane w jego kalendarzu.
          </p>
          <ul className="list-disc pl-5 text-sm mt-3 opacity-80">
            <li>
              Bez zmiany sposobu logowania – łączenie konta tylko do kalendarza.
            </li>
            <li>
              Zakres: tylko &quot;events&quot; (tworzenie/aktualizacja/usuwanie
              wydarzeń).
            </li>
