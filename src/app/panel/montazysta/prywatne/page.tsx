      ...
      {pinnedOrderId ? (
        <Card>
          <CardHeader className="pb-2">
            <CardTitle>Przypięte zlecenie</CardTitle>
          </CardHeader>
            ...
            <Button
              ...
              onClick={async () => {
                await fetch("/api/montazysta/prefs", {
                  ...
                  body: JSON.stringify({ pinnedOrderId: null }),
                });
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle>Brak przypiętego zlecenia</CardTitle>
          </CardHeader>
          <CardContent className="text-sm opacity-70">
            Możesz przypiąć zlecenie ze strony szczegółów zlecenia.
          </CardContent>
        </Card>
      )}
