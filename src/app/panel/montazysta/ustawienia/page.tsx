        ...
        <CardContent>
          <div className="rounded-md border brand-border p-4 space-y-3">
            ...
            <p className="text-sm opacity-80">
              Połącz swój kalendarz Google, aby terminy montaży automatycznie
              pojawiały się w Twoim kalendarzu.
            </p>
            {!isGoogleEnabled && (
              <div className="text-sm text-amber-700 dark:text-amber-300">
                Integracja nieaktywna (brak konfiguracji
              ...
              {isConnected ? (
                <>
                  <span className="text-sm">
                    Status: <span className="font-medium">Połączono</span>
                  </span>
                  <form
                    action="/api/integracje/google/disconnect"
                    method="post"
                  >
                    <button
            ...
            <div className="text-xs opacity-70">
              Po połączeniu będziesz mógł wybrać kalendarz docelowy,
              przypomnienia i strefę czasu.
            </div>
            {isConnected && (
              <div className="mt-4">
                <InstallerPrefs />
