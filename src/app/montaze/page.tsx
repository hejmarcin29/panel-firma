    ...
    <div className="mx-auto max-w-none p-4 md:p-6">
      <section className="relative overflow-hidden rounded-2xl border bg-[var(--pp-panel)] mb-4" style={{ borderColor: 'var(--pp-border)' }}>
        ...
        <div className="relative z-10 p-4 md:p-6 flex items-center justify-between gap-3">
          <h1 className="text-2xl md:text-3xl font-semibold">Montaże — checklisty</h1>
          <Link href="/dostawy" className="inline-flex h-9 items-center rounded-md border px-3 text-sm hover:bg-[var(--pp-primary-subtle-bg)]" style={{ borderColor: 'var(--pp-border)' }}>Przejdź do Dostaw</Link>
        </div>
      </section>
