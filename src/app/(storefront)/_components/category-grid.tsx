    ...
    <section className="py-20 md:py-28">
      <div className="container space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 h-[1200px] md:h-[600px]">
          {/* Main Large Item */}
          <Link href="/sklep?q=dąb" className="group relative overflow-hidden rounded-2xl md:col-span-2 md:row-span-2 bg-gray-100">
            <div 
          ...
          {/* Secondary Item Top */}
          <Link href="/sklep?q=francuska" className="group relative overflow-hidden rounded-2xl bg-gray-100">
            <div 
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
          ...
          <Link href="/sklep?q=winylowe" className="group relative overflow-hidden rounded-2xl bg-gray-100">
            <div 
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
