...
export function MontageDetailsLayout({
  ...
  if (isMobile) {
    return (
      <div className="fixed top-0 left-0 right-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-[100] flex flex-col bg-background overflow-hidden pt-[env(safe-area-inset-top)]">
