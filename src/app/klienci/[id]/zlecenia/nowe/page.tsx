        ...
        <div>
          ...
          <div className="flex gap-6 text-sm">
            ...
            <label className="inline-flex items-center gap-1">
              <input
                type="radio"
                value="installation"
                checked={type === "installation"}
                onChange={() => setType("installation")}
              />{" "}
              Montaż
            </label>
          </div>
          {type === "installation" && (
            <p className="mt-2 text-xs opacity-70">
              Zlecenie wymaga pomiaru przed zaplanowaniem montażu.
            </p>
          )}
        </div>
        <div className="flex items-center gap-2">
          <button
            disabled={submitting}
            className="inline-flex h-10 items-center gap-1.5 rounded-md bg-black px-5 text-sm font-medium text-white hover:bg-black/85 disabled:opacity-50 dark:bg-white dark:text-black dark:hover:bg-white/90"
          >
            {pl.common.save}
          </button>
        </div>
