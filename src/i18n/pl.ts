export const pl = {
  ...
  archiveConfirmDesc: 'Klient i wszystkie jego zlecenia zostaną przeniesione do archiwum. Operację można cofnąć (Przywróć).',
  archiveConfirm: 'Archiwizuj',
  unarchiveConfirmTitle: 'Przywrócić klienta?',
  unarchiveConfirmDesc: 'Klient oraz wszystkie jego zlecenia zostaną przywrócone do aktywnych.',
