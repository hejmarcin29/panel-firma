  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      ...
      <div>
        ...
        {errors?.[n("City")]?.message && (
          <p className="text-sm text-red-600">{errors[n("City")]!.message}</p>
        )}
      </div>
      <div>
        ...
        <Input
          {...register(n("Address"))}
          placeholder="np. Długa 12/5, klatka A, II piętro"
        />
        {errors?.[n("Address")]?.message && (
          <p className="text-sm text-red-600">
            {errors[n("Address")]!.message}
          </p>
        )}
